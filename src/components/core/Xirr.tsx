 ...
 */
export class XirrInner extends BaseVisualization<IPivotTableInnerProps, IPivotTableState> {
    ...
    public getXirr = async () => {
        const fooData = await this.props.dataSource.getData(this.props.resultSpec);

        const totals = fooData.executionResult.totals[0][0] as any;
        const dates = fooData.executionResult.headerItems[1][0].map(
        ...
        console.log("AAAA", fooData, totals, dates, transactions, xirr);
    };
    ...
    public renderVisualization() {
        ...
        return (
            <div className="gd-table-component">
                <div className="gd-table ag-theme-balham s-pivot-table" ref={this.setContainerRef}>
                    THIS IS XIIR
                    {tableLoadingOverlay}
                    <AgGridReact
                        {...gridOptions}
...
export const Xirr = visualizationLoadingHOC(XirrInner, false);
