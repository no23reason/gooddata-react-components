...
export function setXirrUiConfig(
    ...
    set(referencePoint, [UICONFIG, BUCKETS, BucketNames.MEASURES, "allowsSwapping"], true);
    set(referencePoint, [UICONFIG, BUCKETS, BucketNames.ATTRIBUTE, "allowsSwapping"], true);
    set(referencePoint, [UICONFIG, BUCKETS, BucketNames.COLUMNS, "allowsSwapping"], true);

    set(referencePoint, [UICONFIG, BUCKETS, BucketNames.MEASURES, "itemsLimit"], 1);
    set(referencePoint, [UICONFIG, BUCKETS, BucketNames.ATTRIBUTE, "itemsLimit"], 1);
    set(referencePoint, [UICONFIG, BUCKETS, BucketNames.COLUMNS, "itemsLimit"], 1);
